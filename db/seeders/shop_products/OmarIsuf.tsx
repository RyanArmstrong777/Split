export async function seedOmarIsufSplit(db: any) {
    const result = await db.runAsync(
        `INSERT INTO splits (name, description) VALUES (?, ?)`,
        [
            "Omar Isuf Inspired",
            "Balanced powerbuilding split blending strength, hypertrophy, and accessory work, inspired by Omar Isuf."
        ]
    );
    ...
    const workouts = [
        {
            name: "Leg day",
            exercises: [
                { name: "Back Squat", rest_interval: 180, sets: [{ weight: 315, reps: 5 }, { weight: 335, reps: 3 }, { weight: 365, reps: 2 }] },
                ...
                { name: "Leg Extensions", rest_interval: 60, sets: [{ weight: 100, reps: 15 }, { weight: 110, reps: 12 }, { weight: 120, reps: 10 }] },
        ...
        },
        {
            ...
            exercises: [
                ...
                { name: "Overhead Press", rest_interval: 120, sets: [{ weight: 135, reps: 6 }, { weight: 145, reps: 5 }, { weight: 155, reps: 4 }] },
                { name: "Dumbbell Lateral Raise", rest_interval: 60, sets: [{ weight: 25, reps: 15 }, { weight: 25, reps: 12 }, { weight: 25, reps: 12 }] },
                { name: "Triceps Rope Pushdown", rest_interval: 60, sets: [{ weight: 60, reps: 15 }, { weight: 70, reps: 12 }, { weight: 80, reps: 10 }] },
                { name: "Chest Dips", rest_interval: 90, sets: [{ reps: 12 }, { reps: 10 }, { reps: 8 }] },
                { name: "Cable Chest Fly", rest_interval: 60, sets: [{ weight: 30, reps: 15 }, { weight: 35, reps: 12 }, { weight: 40, reps: 10 }] }
            ]
        },
        {
            name: "Pull day",
            exercises: [
                { name: "Conventional Deadlift", rest_interval: 240, sets: [{ weight: 405, reps: 5 }, { weight: 455, reps: 3 }, { weight: 495, reps: 2 }] },
                ...
                { name: "Preacher Curls", rest_interval: 60, sets: [{ weight: 40, reps: 15 }, { weight: 45, reps: 12 }, { weight: 50, reps: 10 }] },
                { name: "Rear Delt Flyes", rest_interval: 60, sets: [{ weight: 20, reps: 15 }, { weight: 20, reps: 15 }, { weight: 20, reps: 15 }] }
            ]
        },
        {
            ...
            exercises: [
                ...
                { name: "Lat Pulldown", rest_interval: 90, sets: [{ weight: 120, reps: 12 }, { weight: 130, reps: 10 }, { weight: 140, reps: 8 }] },
                ...
                { name: "Cable Rope Overhead Triceps Extension", rest_interval: 60, sets: [{ weight: 50, reps: 15 }, { weight: 55, reps: 12 }, { weight: 60, reps: 10 }] }
            ]
        },
        {
            name: "Legs & Core",
            exercises: [
                { name: "Walking Lunges", rest_interval: 90, sets: [{ weight: 40, reps: 12 }, { weight: 45, reps: 10 }, { weight: 50, reps: 8 }] },
                { name: "Leg Extensions", rest_interval: 60, sets: [{ weight: 80, reps: 15 }, { weight: 90, reps: 12 }, { weight: 100, reps: 10 }] },
                { name: "Lying Leg Curls", rest_interval: 60, sets: [{ weight: 90, reps: 15 }, { weight: 100, reps: 12 }, { weight: 110, reps: 10 }] },
                { name: "Standing Calf Raise", rest_interval: 60, sets: [{ weight: 200, reps: 20 }, { weight: 220, reps: 15 }, { weight: 240, reps: 12 }] },
                { name: "Plank Holds", rest_interval: 60, sets: [{ reps: 30 }, { reps: 30 }] },
                { name: "Hanging Leg Raises", rest_interval: 60, sets: [{ reps: 15 }, { reps: 15 }, { reps: 15 }] },
                { name: "Cable Woodchoppers", rest_interval: 60, sets: [{ weight: 40, reps: 12 }, { weight: 45, reps: 10 }, { weight: 50, reps: 8 }] }
            ]
        }
    ];
