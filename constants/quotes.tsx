export const quotes = [
    ...
    "I lift weights... to lift snacks later.",
    ...
    "Why did the skeleton skip the gym? No guts.",
    "Gym? I thought you said gin.",
    "I lift cookies to my mouth daily.",
    "Exercise? I thought you said extra fries.",
    "I’m into fitness... fit this pizza in my mouth.",
    "I run... out of patience quickly.",
    "Burpees? More like ‘burp-ees’.",
    "I have abs... in my dreams.",
    "My warm-up is walking to the fridge.",
    "I’m training for a Netflix marathon.",
    "I lift... my coffee cup.",
    "Exercise is a celebration, not punishment.",
    "My favorite exercise is a cross between a lunge and a crunch – lunch.",
    "I do yoga to stay flexible for naps.",
    "Sweating is my fat crying.",
    "I don’t sweat, I sparkle.",
    "My personal trainer is my reflection.",
    "Squat? I thought you said slot.",
